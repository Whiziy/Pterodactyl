                ...
                <div class="box-body row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <label for="pExpiresAt" class="control-label">Expired In (days)</label>
                            <input id="pExpiresAt" name="expires_in_days" type="number" min="0" class="form-control" value="{{ old('expires_in_days') }}">
                            <p class="text-muted small">Jumlah hari sebelum server otomatis expired. Kosongkan jika tidak ingin expired.</p>
                        </div>
