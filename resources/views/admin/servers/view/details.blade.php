        ...
        <div class="box box-primary">
            ...
            <form action="{{ route('admin.servers.view.details', $server->id) }}" method="POST">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="pExpiresAt" class="control-label">Server Expires At</label>
                        <input type="text" class="form-control" value="{{ $server->expires_at ? $server->expires_at->format('Y-m-d H:i') : 'Never / Not Set' }}" disabled>
                    </div>
                    <div class="form-group">
                        <label for="pExtendDays" class="control-label">Extend By (days)</label>
                        <input type="number" id="pExtendDays" name="extend_days" min="0" class="form-control" value="0">
                        <p class="text-muted small">Masukkan jumlah hari untuk menambah masa aktif server. Isi 0 jika tidak ingin mengubah.</p>
                    </div>
                </div>
